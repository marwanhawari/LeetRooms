...
export default function Login() {
    ...
    if (session) {
        ...
        return (
            <div className="flex h-screen flex-col items-center border-x-8 border-t-8 border-lc-border-light bg-lc-bg-light p-2 text-sm dark:border-lc-border dark:bg-lc-bg">
                <a
