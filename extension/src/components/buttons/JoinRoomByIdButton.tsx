...
export default function JoinRoomByIdButton() {
    ...
    return (
        ...
        >
            <div className="flex flex-row items-center justify-between gap-x-2 rounded-lg border border-transparent bg-lc-fg py-[6px] px-3 text-white focus-within:border-blue-500 hover:border-blue-500">
